...
Find nearby sharing devices automatically or enter an IP address and port manually.
Both modes require matching-code confirmation and check transfer integrity. Contents
remain unencrypted; review the import preview before applying changes.
